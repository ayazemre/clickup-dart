...
void main() {
  ...
  group('Folders Tests', () {
    ...
    test('Folders - Get Folders: Include Archived', () async {
      final folders = await clickUp.folders.getFolders(spaceID: 123, includeArchived: true);
      expect(folders.containsKey("folders"), true);
    });
    test('Folders - Create Folder', () async {
      final folder = await clickUp.folders.createFolder(spaceID: 123, name: "Test Folder");
      expect(folder.containsKey("name") && folder.containsValue("Test Folder"), true);
    });
    ...
    test('Folders - Update Folder', () async {
      final folder = await clickUp.folders.updateFolder(folderID: 123, name: "Test Updated Folder");
      expect(folder.containsKey("name") && folder.containsValue("Test Updated Folder") && folder.containsKey("id"), true);
    });
