...
void main() {
  ...
  group('API endpoint Tests', () {
    ...
    test('Comments - Get Task Comments', () async {
      final taskComments = await clickUp.comments.getTaskComments(taskID: "a1b2c3");
      expect(taskComments.containsKey("comments"), true);
    });
    test('Comments - Create Task Comment', () async {
      final createdComment = await clickUp.comments.createTaskComment(taskID: "a1b2c3", comment: {
    ...
    test('Comments - Create Task Comment - Invalid Data', () async {
      expect(() async => await clickUp.comments.createTaskComment(taskID: "a1b2c3", comment: {}), throwsA(isA<ClickUpException>()));
    });
    ...
    test('Comments - Create Chat View Comment', () async {
      final createdChatViewComment = await clickUp.comments.createChatViewComment(viewID: "12345", comment: {
        "comment_text": "Hi I am Emre",
        "notify_all": true
      });
    ...
    test('Comments - Create Chat View Comment - Invalid Data', () async {
      expect(() async => await clickUp.comments.createChatViewComment(viewID: "12345", comment: {}), throwsA(isA<ClickUpException>()));
    });
    ...
    test('Comments - Create List Comment', () async {
      final listComment = await clickUp.comments.createListComment(listID: "12345", comment: {
        "comment_text": "Hi I am Emre",
        "assignee": 123456,
        "notify_all": true
      });
    ...
    test('Comments - Create List Comment - Invalid Data', () async {
      expect(() async => await clickUp.comments.createListComment(listID: "12345", comment: {}), throwsA(isA<ClickUpException>()));
    });
    test('Comments - Update Comment', () async {
      final updatedComment = await clickUp.comments.updateComment(commentID: 1234, comment: {
        "comment_text": "Hi I am Emre",
        "assignee": 123456,
        "resolved": true
      });
    ...
    test('Comments - Update Comment - Invalid Data', () async {
      expect(() async => await clickUp.comments.updateComment(commentID: 1234, comment: {}), throwsA(isA<ClickUpException>()));
    });
