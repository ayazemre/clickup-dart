...
void main() {
  ...
  group('Custom Fields Tests', () {
    ...
    test('Custom Fields - Get Accessible Custom Fields', () async {
      final customFields =
          await clickUp.customFields.getAccessibleCustomFields(listID: "1234");
    ...
    test('Custom Fields - Set Custom Field Value - URL Custom Field', () async {
      final customField = await clickUp.customFields.setCustomFieldValue(
          fieldID: "1234",
          taskID: "1234",
          value: {"value": "https://ayazemre.com"});
      print(customField);
      expect(customField.isEmpty, true);
    });
    test(
        'Custom Fields - Set Custom Field Value - URL Custom Field - Custom Task ID',
        () async {
      final customField = await clickUp.customFields.setCustomFieldValue(
          fieldID: "1234",
          taskID: "1234",
    ...
    test('Custom Fields - Set Custom Field Value - Wrong Data Model', () async {
      expect(
          () async => await clickUp.customFields.setCustomFieldValue(
              fieldID: "1234",
              taskID: "1234",
              value: {"valeu": "https://ayazemre.com"},
              customTaskID: true,
              teamID: 1234),
          throwsA(isA<ClickUpException>()));
    });
    test('Custom Fields - Remove Custom Field Value', () async {
      final result = await clickUp.customFields
          .removeCustomFieldValue(fieldID: "1234", taskID: "1234");
      expect(result.isEmpty, true);
    });
    test('Custom Fields - Remove Custom Field Value - Custom Task ID',
        () async {
      final result = await clickUp.customFields.removeCustomFieldValue(
          fieldID: "1234", taskID: "1234", customTaskID: true, teamID: 1234);
      expect(result.isEmpty, true);
    });
  });
}
